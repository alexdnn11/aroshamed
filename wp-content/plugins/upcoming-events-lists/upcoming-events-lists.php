		...
		if ( is_singular('event') || is_post_type_archive('event') ) {
			...
			switch ($speaker){
				...
				case "4":
					...
					$desc_speaker="врач-дерматолог отделения дерматологии медицинского центра «Вольфсон» (Холон),<br> специалист международного класса в области косметической дерматологии<br>
Кредо доктора Марины Ландау:   «В работе главное – результат,<br> а в моей практике – методики, доказавшие свою эффективность»";
					break;
				case "5":
