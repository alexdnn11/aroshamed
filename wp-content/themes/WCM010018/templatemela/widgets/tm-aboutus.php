...
class AboutusWidget extends WP_Widget
{
    ...
    function widget($args, $instance){
		...
		echo $before_title ;		
		 ...
		 ?>
		<div class="aboutus_imagecontent animated" data-animated="fadeInLeft" style="<?php echo esc_attr($imageDiv); ?>;opacity:0">
		...
		<div class="tm_aboutus_content" style="<?php echo esc_attr($contentDiv);?>">
			 <?php 
				if($title) : ?>
    ...
    function form($instance){
		...
		<label for="<?php echo esc_attr($this->get_field_id('is_template_path')); ?>"><?php _e('Use Template Path for Image', 'templatemela'); ?></label>
		</p>
		<p>
<label for="<?php echo esc_attr($this->get_field_id('display_image_in')); ?>"><?php _e('Display Image in:', 'templatemela'); ?></label>
 <select id="<?php echo esc_attr($this->get_field_id( 'display_image_in' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'display_image_in' )); ?>" class="widefat">
